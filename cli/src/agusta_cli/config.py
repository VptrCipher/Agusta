...
GLOBAL_SETTINGS_PATH = Path.home() / ".agusta" / "settings.json"
LOCAL_SETTINGS_DIR = ".agusta"
...
def resolve_config(*, cwd: Path | None = None, api_url: str | None = None, api_key: str | None = None) -> ResolvedConfig:
    ...
    _merge(
        ...
        sources,
        {
            "api_url": os.environ.get("AGUSTA_API_URL"),
            "api_key": os.environ.get("AGUSTA_API_KEY"),
        },
        "env",
    )
