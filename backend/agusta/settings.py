...
AGUSTA_WEB_TIMEOUT = _env_int("AGUSTA_WEB_TIMEOUT", 210)
SYNC_OPERATION_TIMEOUT_SECONDS = max(1, AGUSTA_WEB_TIMEOUT - 30)
...
WSGI_APPLICATION = "agusta.wsgi.application"
ASGI_APPLICATION = "agusta.asgi.application"

DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql",
        "NAME": os.environ.get("POSTGRES_DB", "agusta"),
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_SCHEMA_CLASS": "apps.common.openapi.AgustaAutoSchema",
    "EXCEPTION_HANDLER": "apps.common.exceptions.custom_exception_handler",
}

SPECTACULAR_SETTINGS = {
    "TITLE": "AGUSTA API",
    "DESCRIPTION": "HTTP API for AGUSTA. External automation integrations should prefer API keys.",
    "VERSION": "0.5.2",
...
AWS_STORAGE_BUCKET_NAME = os.environ.get("RUSTFS_BUCKET", "agusta")
