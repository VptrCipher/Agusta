...
function SelectOptionLabel({ label, value, color }: { label: ReactNode; value?: unknown; color?: string }) {
  ...
  const iconColor = resolvedColor || 'rgba(240, 238, 231, 0.45)'
  return (
      ...
      >
        <span style={{ display: 'block', width: '100%', minWidth: 0 }}>
          ...
          >
            ...
            <DownOutlined style={{ color: 'rgba(240, 238, 231, 0.35)', fontSize: 10, marginLeft: 'auto', flexShrink: 0 }} />
          </button>
        </span>
      </Popover>
    </div>
