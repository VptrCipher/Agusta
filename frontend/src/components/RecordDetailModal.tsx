    ...
    <Modal
      ...
      styles={{
        ...
        container: {
          ...
          boxShadow: '0 28px 88px rgba(0, 0, 0, 0.9), 0 0 0 1px rgba(240, 238, 231, 0.04)',
          overflow: 'hidden',
        },
      ...
      destroyOnHidden
    >
      <div style={{ display: 'flex', height: modalHeight, background: token.colorBgContainer, color: 'rgba(240, 238, 231, 0.85)' }}>
        {showContentRail && (
          <div
            style={{
        ...
        <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ flex: 1, minHeight: 0, display: 'flex', position: 'relative' }}>
            ...
            {showActivity && activityDrawer && objectId && (
              <div style={{ width: 420, borderLeft: dividerBorder, display: 'flex', flexDirection: 'column', background: '#161514', minHeight: 0 }}>
